"""3D segmentation models: STU-Net and TotalSegmentator (nnU-Net).

STU-Net: https://github.com/uni-medical/STU-Net
TotalSegmentator: https://github.com/wasserth/TotalSegmentator (uses nnU-Net PlainConvUNet)
"""
...
class BasicResBlock(nn.Module):
    """Basic residual block for STU-Net."""
...
class Decoder(nn.Module):
    """Decoder placeholder for deep supervision flag."""
...
class STUNet(nn.Module):
    """STU-Net architecture from https://github.com/uni-medical/STU-Net."""
...
def create_stunet_s(num_classes=NUM_CLASSES):
...
def create_stunet_b(num_classes=NUM_CLASSES):
...
def create_totalsegmentator(num_classes=NUM_CLASSES):
